...
**To make Jupyter notebooks easy to run using Binder, repositories containing those notebooks are retained on the [OSYM GitHub site](https://github.com/orgs/organismal-systems/repositories), from which they are linked in the book. 
...
For example, to [install required packages using miniconda or Anaconda](https://docs.conda.io/projects/conda/en/latest/user-guide/tasks/manage-environments.html), use a terminal window to execute
```bash
