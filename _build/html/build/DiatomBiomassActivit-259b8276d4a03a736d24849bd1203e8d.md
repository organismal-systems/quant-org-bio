# 🛼 Size-dependence of diatom biovolume in mixed layers: Interpretation
In this part of the Activity, you will interpret the model results you tabulated in the [data collection phase](./DiatomBiomassActivity3.md).
...
These questions are related, in that both refer to diatom biovolume as a proxy, in one case for rate of primary production by the diatom population, and in the other for the "payoff" available to a grazer or pathogen attacking the diatom population.

- Examine the table and plot you made of biovolume as a function of diatom size class and mixing interval.  
...
- Examine the table and plot you made of nutrient concentration as a function of diatom size class and mixing interval.  
...
Recall that the rationale of the mini-study was the assumption that standing stock of 
