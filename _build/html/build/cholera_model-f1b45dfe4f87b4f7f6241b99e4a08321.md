...
Where the mortality rate associated with infection is negligible and the population *N* is constant (or otherwise known) *SIR* models simplify to two population classes, $S$ and $I$, where $R = N - S - I$ is implicit.
