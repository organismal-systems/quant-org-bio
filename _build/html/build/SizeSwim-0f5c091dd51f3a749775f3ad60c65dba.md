...
In particular, the expectation for ciliary propulsion is that the propulsive force, $F_{cilia}$, should increase, to a rough approximation, proportionately to the surface area of a ciliated spheroid.
That is, 
$$
F_{cilia} \propto L^2
$$
