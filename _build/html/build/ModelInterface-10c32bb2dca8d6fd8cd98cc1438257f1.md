...
For example, Litchman *et al.* posed the hypothesis that the interval between mixing events affected the stable diatom size distribution so as to favor larger diatoms than expected in mixed layers without mixing events.
