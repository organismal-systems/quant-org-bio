...
- Because [the outcomes of competition can differ from ESS's](./EvolutionarilyStableStates.md), the test for whether a variant (or combination of variants) is an ESS is different than a test for "winners" of competition among a mixed population.  
...
- Many population models are deceptively slow in arriving at "steady state", particularly when there are many similar competing variants.  
