...
>In this Activity, we assume that the size-specific standing stock of diatoms is a **proxy** for the relative rate of  primary production, availability to grazers and pathogens, and intensity of competition among primary producers.
