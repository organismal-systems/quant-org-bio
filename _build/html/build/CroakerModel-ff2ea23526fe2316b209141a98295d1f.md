...
The fecundity, $F_i$, *implicitly* accounts for this variation by discounting the per-fish fecundity to factor in fish that died before they had a chance to reproduce, the fish that reproduced but died before the end of the year, *etc*.
