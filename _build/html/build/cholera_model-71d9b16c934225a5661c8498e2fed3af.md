...
$$ (inf)
  ...
  - $\alpha$ and $\gamma$ are "clustering" exponents, intended to account for the fact that populations are not freely mixing &ndash; infected individuals are on average more likely to interact with other infected individuals than would be expected if interactions were completely random.
