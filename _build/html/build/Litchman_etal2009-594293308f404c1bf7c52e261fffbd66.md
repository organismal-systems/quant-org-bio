...
After substituting each of the mathematical expressions in [](#A1)-[](#A4), the quantitative expression of the verbal mixed layer diatom populations model in  Equations [](#W2), [](#W1) and [](#W3) is:
```{math}
:label: L1
