...
Other costs may include delays to metamorphosis, if the smaller clones must undergo additional growth to reach a threshold size, or the costs of forming a smaller juvenile if the clones metamorphose before growing enough to make up for dividing resources from the original larva.
...
1. *The echinoid mode of cloning*
	...
	ome marine invertebrate larvae simply bifurcate during development, prior to having grown and developed 
