...
\begin{equation}
\label{eqnM2}
	DF = \frac{t_1}{t_0} = { \frac{1}{\alpha} ~\ln{\frac{M_{mat}}{EIF~ M_0}} }{\frac{1}{\alpha} ~\ln{\frac{M_{mat}}{M_0}} }
\end{equation}
where $DF$ is the \textit{duration reduction factor}.
...
\end{equation}
Substituting the right hand side of (\ref{eqnM0b}) into (\ref{eqnDF}),
\begin{equation}
\label{eqnDF2}
DF = 1 - {\ln{E}}{ \alpha t_0 }
\end{equation}
