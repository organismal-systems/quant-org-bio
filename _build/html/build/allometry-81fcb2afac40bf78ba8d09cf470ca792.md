...
A plot of Kleiber's law, relating the metabolic rates of organisms to their sizes across a large range of sizes. See the Wikipedia article on [Kleiber's law](wiki:Kleiber's_law) for details. The vertical axis is Basal Metabolic Rate ($watts$); the horizontal axis is body mass ($kg$).
```
