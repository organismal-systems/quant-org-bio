...
[^len]: It's worth noting that, if individuals always moved in the same direction, the time to encounter non-habitat would be proportional to $L$.
	...
	$L^2$ is the next available power of $L$, so this too is plausible.
