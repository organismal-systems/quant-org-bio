...
These questions related, in that both refer to diatom biovolume as a proxy, in one case for rate of primary production by the diatom population, and in the other for the "payoff" available to a grazer or pathogen attacking the diatom population.
