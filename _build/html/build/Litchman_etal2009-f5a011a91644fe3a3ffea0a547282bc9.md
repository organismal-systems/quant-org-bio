...
The cell's nutrient uptake rate approaches zero as its quota approach its maximimum capacity, $Q_{max,i}$.
%Because $C_2=C_3$ when the cell quota is $Q_i = Q_{max,i}$, t
