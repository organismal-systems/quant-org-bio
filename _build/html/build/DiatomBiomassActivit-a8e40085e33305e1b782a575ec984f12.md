...
13. When the tables are complete, make X-Y Scatter plots of the data using the spreadsheet's Chart funtion. 
	...
	- The title of the $BV$ plot is "1-spp variation of biovolume with size and mixing interval". 
	- The title of the nutrient concentration plot is "1-spp variation of nutrient concentration with size and mixing interval". 
...
5. Make a chart with $T_{mix}$ on the horizontal axis, and total biovolume on the vertical axis.  
   Make another chart with  $T_{mix}$ on the horizontal axis, and nutrient concentration on the vertical axis.  
	- The title of the $BV$ plot is "Multi-spp variation of biovolume with size and mixing interval". 
	- The title of the nutrient concentration plot is "Multi-spp variation of nutrient concentration with size and mixing interval". 
