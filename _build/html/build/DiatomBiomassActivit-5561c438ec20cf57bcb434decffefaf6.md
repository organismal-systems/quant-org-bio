...
Diatoms are major prey species for aquatic grazers, important hosts for aquatic pathogens, and effective competitors for other primary producers.
...
> What are the consequences for diatom grazers, pathogens and competitors of different mixed layer characteristics?
...
The outcome of the mini-study will be a set of hypotheses, in a form that could be tested with an empirical study.

## Mini-study rationale

[Litchman *et al.* (2009)](https://www.pnas.org/doi/epdf/10.1073/pnas.0810891106)'s model uses observed allometries of growth, nutrient uptake and nutrient storage quotas to test hypotheses about the outcomes of competition and evolution among populations of different-sized diatoms.
This model predicts, among other things, the size-specific standing stocks of diatoms (expressed as biovolume) across variation in [mixed layer](./MixedLayers.md) characteristics.

>In this Activity, we assume that the size-specific standing stock of diatoms is a **proxy** for the effects of mixed layer characteristics on primary production, availability to grazers and pathogens, and intensity of competition among primary producers.
