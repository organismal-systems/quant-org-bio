...
- The sample mean of an ensemble of estimates $n_1, n_2,\dots$ is an unbiased and efficient estimator of $\rho$. Nonetheless, if $\rho$ is small the number of samples must be large to accurately estimate $\rho$.
