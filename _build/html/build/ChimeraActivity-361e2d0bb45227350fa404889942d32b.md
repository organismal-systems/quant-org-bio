...
- The model is executed in two stages:
  - **Specification of larval morphology**
	...
	- The Jupyter notebook [](./ChimeraOrg.ipynb) provides an alternative interface for approximating a subset of early-stage larval morphologies, specified with organism-based parameters such as tissue volume, aspect ratio, excess density, *etc*.. 
