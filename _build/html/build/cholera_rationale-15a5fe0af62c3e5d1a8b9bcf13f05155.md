...
```
In our implementation of the model, climatic variation is approximated by a linear increase to the midpoint of the simulation, followed by a linear decrease.
