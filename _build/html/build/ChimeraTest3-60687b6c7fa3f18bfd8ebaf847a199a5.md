...
2. **Select a series of values for tissue volume $V_t$ and excess density $\rho_{excess}$** over which to quantify swimming metrics.  
    ...
    - The excess density, $\rho_{excess}$, is constrained because the average larval density, $\rho_{excess}+\rho_{seawater}$ cannot be less than the inclusion density $\rho_{inclusion}$ (its lightest constituent) or more than the tissue density $\rho_{tissue}$ (its heaviest constituent).  
