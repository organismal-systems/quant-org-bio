...
- $\mathbf{\hat{P}}$ is the stable age distribution approached by the croaker population.
	...
	- $\mathbf{\hat{P}}$ is typically normalized, to have a unit population size or "vector length".[^norm]
...
[^norm]: This is not always the case, and furthermore in other linear algebra applications other ways of normalizing such vectors are more common. However, in application to a Leslie matrix population model, this normalization is the most convenient.
