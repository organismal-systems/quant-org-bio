...
[Allometry](wiki:Alometry) is the study of systematic variation of organismal traits across variations in size. 
...
Allometry is a useful tool for understanding linkages among aquatic organisms across organizational scales between these and many other traits.
...
Diatoms are diverse, with estimates of the number of species ranging from 20,000 to as high as 200,000.
Diatoms are also abundant, and are estimated to produce 20-50% of new oxygen generated worldwide each year.
...
Diatoms are encased in hard silica shells called [frustrules](wiki:Frustrule).
...
A plot from [Wikipedia](wiki:Frustrule) of frustrules from four species of diatoms (scale bar = 10 micrometres in a, c and d and 20 micrometres in b).
```

diatom cells can sink rapidly into deep water, effectively contributing to sequestration of carbon fixed by photosynthesis away from surface layers.



out of surface waters, 

have silicified major components of ity  and abundantof central importance at ecosystems scales, producing 

In 2009, [Litchman et al.](https://www.pnas.org/doi/epdf/10.1073/pnas.0810891106) published a survey of diatom size distributions across a number of marine and freshwater environments.
They found that, 
