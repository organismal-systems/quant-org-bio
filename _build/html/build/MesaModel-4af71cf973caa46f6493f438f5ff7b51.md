...
As in that analysis, the goal is to obtain an order of magnitude estimate for key thresholds determinning "big-picture" outcomes using the minimum possible amount of demographic data.
