...
The [Wolf-Sheep-Grass  simulation](../../../subrepos/spatial-dynamics/MesaWolfSheep/WolfSheepPersits.ipynb) is an example of this: the individual-based stochastic model has completely different dynamics than the ODE or PDE approximations to it.
