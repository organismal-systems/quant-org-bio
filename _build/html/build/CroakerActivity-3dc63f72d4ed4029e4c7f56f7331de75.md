...
> - What are the similarities and differences between the time series for total population in the full model and the time series for the stable age distribution (derived from stable age distribution analysis)?
