...
9. Repeat steps 1-7, but this time change the "all" to "3,5" in the **Size classes ($S_i$) to seed** textbox in the  **Seeding the mixed layer with diatom variants** section.
