...
Borrowing results from the KISS model analysis, we can use the knowledge that both time and space steps are 1 in the Wolf-Sheep model:
- $\Delta x = 1$
- $\Delta t = 1$
...
> - $T_{demog} \gg 4 L^2$, in which agents move across the domain quickly but demography happens slowly
> - $T_{demog} \ll 4 L^2$, in which demography happens quickly but agents move across the domain slowly

> - $\frac{T_{demog}}{4 L^2} \gg 1$, in which agents move across the domain quickly but demography happens slowly
> - $\frac{T_{demog}}{4 L^2} \ll 1$, in which demography happens quickly but agents move across the domain slowly
