...
1. You will tabulate the **number of cells**, to determine the "winning" variant under different mixing intervals, when an entire spectrum of diatom size variants is initially present.
...
2. You will also record **how many days** are required for the diatom population to reach a "steady state" &ndash; that is, a constant period-averaged variant populations.
