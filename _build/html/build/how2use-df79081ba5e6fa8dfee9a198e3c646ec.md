...
"In context" means that these examples provide:  
- brief background (with additional outside references); 
- one or more working "executable" models; 
- instructions how to use the models; and 
- suggested activities for exploring potential implications of the model for interesting questions in Larval Biology.
