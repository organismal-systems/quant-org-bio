...
:align: center
:label: kol1
| Dissipation rate, $\epsilon$ | length scale, $l_K=\left( \frac{\nu^3}{\epsilon} \right)^{\frac{1}{4}}$ | time scale, $\tau_K=\left( \frac{\nu}{\epsilon} \right)^{\frac{1}{2}}$ | velocity scale, $v_K=\left( \nu \epsilon \right)^{\frac{1}{4}}$ |
| --- | --- | --- | --- |
| $10^{-4}$ | $3.16 \times 10^{-4}$ | $1. \times 10^{-1}$ | |
| $10^{-5}$ | $5.62 \times 10^{-4}$ | $3.16 \times 10^{-1}$ | |
| $10^{-6}$ | $1.0 \times 10^{-3}$ | $1.0$ | |
1| $10^{-7}$ | $1.78 \times 10^{-3}$ | $3.16$ | |
| $10^{-8}$ | $3.16 \times 10^{-3}$ | $10.0$ | |
| $10^{-9}$ | $5.62 \times 10^{-3}$ | $31.6$ | |
| $10^{-10}$ | $1.0 \times 10^{-2}$ | $100.$ | |
