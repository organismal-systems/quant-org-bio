...
With these estimates, we can proceed on the (speculative) assumption that growth rates on the order of $\alpha = 0.1 day^{-1}$ are within the realm of plausibility. 
