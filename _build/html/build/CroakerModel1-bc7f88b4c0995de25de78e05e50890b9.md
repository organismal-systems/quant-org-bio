...
That is because sperm are usually available in much greater numbers, most of which never encounter an egg and hence play no part in reproduction.  
    ...
    Accounting for all Year Classes, the population of female eggs ($p_1$) produced by females surviving to the end of year $t$ to develop during year $t+1$ is then  
    $$
