...
Another effect of "inclusions" within early-stage larvae is to alter stability and re-orientation.
...
A consequence is that when the $C_{mass}$ is offset horizontally from the $C_{buoy}$, the downwards gravity force and the upwards buoyancy force exert a torque
