...
- The parameter Egg Investment Factor, $EIF$, is simply a multiplier by which each female will hypothetically increase or decrease the reproductive resources expended on each egg (with a proportional decrease or increase of the number of eggs produced, given a fixed constraint on reproductive resources).  
