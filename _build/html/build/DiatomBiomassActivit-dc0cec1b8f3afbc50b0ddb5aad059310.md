...
This concludes the data collection for Part 1 of this Activity.
...
1. Choose parts of your spreadsheet for new biovolume and nutrient concentration tables, or start a new one.  
   In each, start a column labels $Tmix$ and enter the sequence of mixing intervals to assess: $T_{mix} = 8, 16, 32, 64$.
2. 
