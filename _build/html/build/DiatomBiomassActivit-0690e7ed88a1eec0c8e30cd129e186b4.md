...
4. Scroll down to the **Seeding...** section.  
   Seed the population with diatoms of the smallest size class, by **setting** $i=0$ **in the textbox** (replacing "all"), then clicking the **Seed cell population** button.
   
   Note that, if there are 8 size classes, these are numbered 0 to 7.
5. Scroll down to the **Setting mixing events...* section, and click on the **Run simulation** button using the default settings.
