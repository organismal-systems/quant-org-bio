...
2. Experiment with the model to familiarize yourself with how to change the simulation, demographic and evolutionary parameters, and how to interpret the output.


Once you have gained an intuition about how various parameters affect larval survivorship, Year Class structure and long-term population trends, use the notebook to address the questions in some or all of the following topic areas.
...
They based their conclusions on [stable age distribution analysis](./CroakerModel4.md) of this model.
