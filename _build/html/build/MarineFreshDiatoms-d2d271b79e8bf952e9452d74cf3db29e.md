...
Litchman *et al.* asked why this disparity in size distributions should exist between marine and freshwater habitats.

Litchman *et al.* noted that diatom populations typically inhabit the [mixed layer](wiki:Mixed_layer) within aquatic environments.
...
Typically, surface waters tend to be higher temperature (e.g., because they are warmed by the sun or warm air) and/or lower salinity than deeper waters.
...
Stirring from wind typically overcomes stratification near the surface, it usually penetrates only partway into a water column.
