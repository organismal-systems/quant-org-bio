...
Much of the discussion in this book involves [scale models](wiki:Scale_model).
...
This concept is called ["dynamic similarity"](wiki:Similitude) or "similitude".
...
:::{iframe} https://www.youtube.com/watch?v=8hghNqCZmso
:width: 100%
...
As you watch this video, consider your intuition about how big the model is.
 ...
 and [non-dimensional numbers](wiki:Dimensionless_quantity) (also known as "dimensionless quantities")
