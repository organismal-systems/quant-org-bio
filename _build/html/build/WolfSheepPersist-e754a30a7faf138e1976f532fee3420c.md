...
The first part of this Unit uses scaling analysis to derive a "back-of-the-envelope" estimate for the minimum habitat size that can support a viable population in the so-called KISS model [^kiss].
