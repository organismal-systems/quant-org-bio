...
- The transmission rate for month $t$ is $\beta_t = \beta_{season} \beta_{climate}$, where
  - $\beta_{season}$ is the seasonal transmission component, defined over the 12 months of a year
  - $\beta_{climate}$ is the climate transmission component, defined over an extended period of several years
