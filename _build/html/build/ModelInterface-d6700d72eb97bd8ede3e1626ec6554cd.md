...
They envisioned a plot (their Figure 1) that would effectively test this hypotheses by showing the size distributions of several examples from each habitat type. 
If the plot showed a systematic difference between the two types of habitat (it did) that would be compelling evidence in support of the hypothesis, and *vice versa*. 
