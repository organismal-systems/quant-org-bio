...
It's important to understand that running the simulation multiple times with the same random seed will give exactly the same results.
To have a replicate run of the simulation, you must change the random seed.
