...
- a large diatom cell likely has faster primary production than a small diatom cell
%; because the model does not have a more detailed calculation for this size dependence, cell volume is the best available metric.
