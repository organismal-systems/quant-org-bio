...
Because shear has units of $s^{-1}$, Kolmogorov's analysis suggests that the intensity of this shear in the smallest eddies should scale approximates as $\frac{1}{\tau_K}$.
That ranges from $10 s^{-1}$ at the highest dissipation rates in [](#kol1) 
