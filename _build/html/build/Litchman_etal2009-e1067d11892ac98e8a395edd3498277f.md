...
## Model formulation
Litchman *et al.* formulated a model that keeps track of the number of cells, and the nitrogen quota of each cell, for populations of a series of differently-sized diatom variants.
