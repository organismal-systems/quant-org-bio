...
These scales were defined using dimensional analysis by Kolmogorov as functions of the turbulent energy dissipation rate, $\epsilon$:

:::{table} Table of Kolmogorov microscales
:align: center
:label: kol1
