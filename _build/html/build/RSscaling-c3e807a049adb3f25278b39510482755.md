...
These simplified equations are called the [Stokes equations](wiki:Stokes_flow), and the flow they describe with $\mathcal{Re} \ll 1$ is called [Stokes flow](wiki:Stokes_flow).
