...
1. Select a focal shape  
    That is, choose fixed values for aspect ratio $\alpha$, relative equator position $\eta$, tissue density $\rho_{tissue}$ and inclusion density $\rho_inclusion$.
