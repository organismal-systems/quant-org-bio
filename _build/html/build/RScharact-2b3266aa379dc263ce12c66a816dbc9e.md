...
```
In generic terms, we can describe this organism using **characteristic values** (also see the discussion on [scale models](../../qob-notebooks/scale-models.ipynb) and [nondimensional numbers](../../../content/overview/nondim-numbers.md) in the Overview). 
