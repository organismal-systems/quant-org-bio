...
<span style="color:blue">It's important to understand that running the simulation multiple times with the same random seed will give exactly the same results.
