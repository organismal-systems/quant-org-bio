...
5. The next set of textboxes specifies simulation parameters:  
    - Set the Euler angle $\theta$ to $1.570796$ radians, which is $\frac{\pi}{2}$ so that the larva's initial orientation is $90^\circ$ from its stable upwards orientation.
