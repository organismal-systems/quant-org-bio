...
Because the excess density is an expression of the difference between gravity and buoyancy forces, Equation {eq}`fbod2` is a restatement of Equation {eq}`fbod` in the [previous page](./SizeSwim.md).
