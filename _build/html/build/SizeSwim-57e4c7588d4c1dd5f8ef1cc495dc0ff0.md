...
Most of the benefits of swimming depend on 
Early-stage larvae typically do not have sophisticated active responses to turbulence and shear.[^adv]
Instead, they usually rely on passive stability &ndash; that is, on the reorientation tendency to 

%When inclusions with excess densities differing from tissue present within a developing embryo, the embryo's internal mass is non-uniformly distributed.

%This non-uniformity typically means that 


%is in a different position than the 

%Stability and re-orientation are determined
