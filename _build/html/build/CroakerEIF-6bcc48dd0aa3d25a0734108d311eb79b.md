...
Using their estimates for the duration of the Ocean Larva stage and other metrics,
...
:align: center
:label: parsD
| Region | Duration | Init. Length | Final Length | Inferred Mass Incr., $\frac{M_{mat}}{M_0}$ |
| --- | --- | --- | --- | --- |
| Atlantic | 39.8 days | $2~mm$ | $11.0 ~mm$ | 166.4 |
| Gulf | 45 days | $2.~mm$ | $7.9~mm$ | 61.6 |
:::




If we assume that larvae grow approximately isometrically, then the corresponding growth factor estimates in terms of mass are
- Atlantic: $\alpha = 0.2136 \times 3 = 0.6408 $.
- Gulf: $\alpha = 0.1316 \times 3 = 0.3948 $.  
