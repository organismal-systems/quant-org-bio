...
$$
Equation [](#kiss8) is the non-dimensional form of the KISS model, for a population constrained to a habitat of non-dimensional size $L=\sqrt{\alpha D} L^*$, and was the goal of the analysis.
...
Knowing this, we can infer that the solution will look lime
4$s(x)=\sin{\frac{\pi n x}{L}},~n=1,2,\dots$
$$
where $L=\sqrt{\frac{\alpha}{D}}~L^*$, to fit boundary conditions
