...
```
In generic terms, we can describe this organism using **characteristic values** (also see the discussion on Scale models and [nondimensional numbers](./nondim-numbers.md) in the Overview). 
