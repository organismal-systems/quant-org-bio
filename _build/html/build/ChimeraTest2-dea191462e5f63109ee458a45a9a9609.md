...
- Because shear has units of $s^{-1}$, Kolmogorov's analysis suggests that the intensity of this shear in the smallest eddies should scale approximates as the inverse of the time scale, $\frac{1}{\tau_K}$.
