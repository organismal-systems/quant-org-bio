...
>In this Activity, we assume that the size-specific standing stock of diatoms (expressed as biovolume) as a **proxy** that indicates the relative effects of mixed layer characteristics on primary production, prey availability to diatom grazers and intensity of competition among primary producers.
