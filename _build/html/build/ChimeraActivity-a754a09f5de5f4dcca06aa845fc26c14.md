...
Specifically, two hypothetical "performance standards" were proposed: swimming speed and stability.

The benefits and costs of swimming are complex, poorly understood and highly variable, making it difficult to critically assess tradeoffs implied by this hypothesis, beyond the type of observations and analysis that first motivated them.
...
## A hypothetical performance standard for swimming speed

The upward swimming speed of early stage larvae in still water meet or exceed a minimum speed, $V_{min}$.
The observations and analysis of [](doi:10.1093/icb/icq090) suggested that the minimum speed performance requirement is in the vicinity of $350 \frac{\mu m}{s}$.

## A hypothetical performance standard for stability
