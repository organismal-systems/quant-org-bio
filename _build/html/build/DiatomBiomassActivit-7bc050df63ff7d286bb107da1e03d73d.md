...
The impacts diatom populations have, in these roles and others, is strongly mediated by the [standing stock](wiki:Population_density) of diatoms of different sizes.

[Litchman *et al.* (2009)](https://www.pnas.org/doi/epdf/10.1073/pnas.0810891106)'s model derived a model of competing 

simulating changes analyzed the size distributions of diatoms




Among the highly diverse characteristics of diatoms is their 
The consequences of diatom size &ndash; in particular, the allometries of growth, nutrient uptake and nutrient storage quotas
