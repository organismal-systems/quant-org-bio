...
Some of the allometries that Litchman *et al.* reported for nitrogen-limited diatoms are shown in [](#Table1).

equation [](#L0a)

```{csv-table} 
Allometric constants for nutrient uptake and growth in diatoms
:label: Table1
