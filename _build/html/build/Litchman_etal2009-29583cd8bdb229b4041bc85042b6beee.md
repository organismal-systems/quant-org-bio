...
## Model rationale
The rationale for Litchman *et al.*'s model is based on accounting for nutrient concentration in the water, the numbers of cells of different diatom variants, and those cells' nutrient quotas.
...
```
Finally, the nutrient concentration is reduced, between mixing events, when nutrients are taken up by diatoms:
```{math}
:label: W3
