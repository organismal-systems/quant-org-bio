...
Diatoms are encased in hard silica shells called [frustules](wiki:Frustule).
...
A plot from [Wikipedia](wiki:Frustule) of frustules from four species of diatoms (scale bar = 10 micrometres in a, c and d and 20 micrometres in b).
```
