...
Within one test, other parameters that determine shape and material properties are held constant.
...
| --- | --- | --- |
| Aspect ratio | $\alpha$ | 0.95 |
| Relative equator position | $\eta$ |  |
| Relative inclusion position | $\sigma$ | 50 |
| Tissue density | $\rho_{tissue}$ | 1070 |
| Seawater density | $\rho_{seawater}$ | 1030 |
:::
The aspect ratio, $\alpha$, is a shape parameter determining the height of the larva relative to its diameter.
The relative equator position, $\eta$, 
