...
begins with a constrained parameter space.

In this parameter space, the fixed parameters are:
- Aspect ratio, $\alpha$
- Relative equator position, $\eta$
- Relative inclusion position, $\sigma$
...
- Tissue volume, $V_t$
- Average excess density, $\rho_{excess}$  
