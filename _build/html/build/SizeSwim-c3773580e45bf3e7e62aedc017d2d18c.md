...
Because the excess density is an expression of the difference between gravity and buoyancy forces, Equation {eq}`bod2` is a restatement of Equation {eq}`sir`.
