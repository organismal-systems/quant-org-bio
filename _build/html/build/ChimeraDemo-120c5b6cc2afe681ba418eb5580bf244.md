...
The parameter values below are illustrative, based loosely on data in Ref. 1 ([](doi:10.1093/icb/icq090)) and Ref. 2 ([](https://doi.org/10.1242/jeb.060541)).
...
3. Define organism-based morphological parameters:  
    - $\rho_{excess}=300$  
	  ...
	  It is derived from the largest density observed in 
    - $V_t$
