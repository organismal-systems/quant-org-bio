...
> - The population in a Leslie matrix model always approaches a **stable age distribution**, in which the proportion of the population in each age class remains constant.
>  - The size of the population in this stable age distribution always increases or decrease geometrically, by a constant factor each time increment (in this case, each year).


[](doi:10.1139/cjfas-57-10-2010) utilized the fact that 
