...
We know this because there is no other way to construct a quantity with the units of area and volume using the only available characteristic dimensional, $L$.
...
That is, our measurements tell us that the constant of proportionality of surface area to $L^2$ is $\pi$, and the constant of proportionality of volume to $L^3$ is $\frac{\pi}{6}$.
