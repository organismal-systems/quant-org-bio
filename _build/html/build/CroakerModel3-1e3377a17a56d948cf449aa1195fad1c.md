...
Hence, its duration in the Yolk-Sac Larval stage is shorter, and its probability of surviving commensurately higher.
...
$$
p_{eggs}(i+1) = \frac{1}{EIF} \sum_{i=1}^8 F_i~p_i(t)
$$
