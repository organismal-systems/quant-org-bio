...
The specific rationale for this assumption rests on their density-independent "background" mortality term ($\mu N_i$, where $N_i$ is the number of cells of size class $i$ and $\mu$ is the mortality rate).
