...
Specifically, two hypothetical requirements drawn from the observations and analysis of [](doi:10.1093/icb/icq090) were suggested in the [preceding discussion](./SizeSwim.md):
1. **Swimming speed**: The upward swimming speed of early stage larvae in still water must be at least $350 \frac{\mu m}{s}$.
2. **Stability**: Early stage larvae must be capable of maintaining vertical orientation in the shear and turbulence characteristic of the habitats in which they undergo development.
