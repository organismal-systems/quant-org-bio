...
The first part of this Unit uses scaling analysis to derive a "back-of-the-envelope" estimate for the minimum habitat size that can support a viable population, as predicted by the so-called KISS model [^kiss] (due to Kierstead, Slobodkin and Skellam).
...
[^kiss]: Kierstead, H.; Slobodkin, L.B. The Size of Water Masses Containing Plankton Bloom. J. Mar. Res. 1953, 12, 141–147.--
and  
