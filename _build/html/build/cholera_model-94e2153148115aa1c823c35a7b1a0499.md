...
- The transmission rate for month $t$, $\beta_t$, is the product of two factors:
  - the seasonal transmission component, $\beta_{season}$
  - the climate transmission component, $\beta_{climate}$
