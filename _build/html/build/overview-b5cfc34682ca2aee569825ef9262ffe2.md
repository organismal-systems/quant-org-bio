...
Even more broadly, most experimental design is based (often on an unspoken, intuitive level) on assumptions about how a measurement or manipulation carries implications for a biological process &ndash; in other words, a model. 
...
A future Organismal Biology in which the potential of models to enhance discovery is more fully exploited &ndash; in which quantitative models are freely interdigitated among empirical methods and observations where each approach can best contribute  &ndash; would be a more interesting, productive and impactful discipline.
