...
This page explains key mathematical elements of [Koelle *et al*. (2005)](https://doi.org/10.1038/nature03820)'s cholera model.
...
- The immunity level, $\kappa_i$, is the fraction of people retaining an acquired immunity to cholera $i$ months after they have recovered.
  - The immunity level at $t=0$ is $A$, the number of asymptomatic (or otherwise unreported) cholera infections for each reported infection.[^k6]
...
[^k5]: In this implementation, $\beta_{season}$ is a periodic function with linearly decreasing amplitude, that is vaguely reminiscent of the seasonal pattern determined by Koelle *et al*. but mostly chosen for convenience.
[^k6]: The immune function is the fraction of the **actual** recovered population that is protected, as a multiplier of the **reported** number of cases. Because many cases are asymptomatic or otherwise unreported, the reported caseload may drastically underestimate the actual number of cases. The ratio of asymptomatic to symptomatic cases is an unknown parameter that Koelle *et al* had to estimate as part of their analysis. 
