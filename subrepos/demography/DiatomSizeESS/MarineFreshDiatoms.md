...
[Allometry](wiki:Allometry) is the study of how organismal traits vary with organism size. 
Among aquatic[^aqu] organisms, size is associated with variations in numerous other traits and processes, across all of the organizational scales relevant to Organismal Biology.
...
[Allometry](../../../content/overview/allometry.md) is a useful tool for understanding linkages between these and many other characteristics of aquatic organisms.
...
This type of regulation of a population by higher trophic levels is called [top-down control](wiki:Population_ecology#Top-down_and_bottom-up_controls).

Litchman *et al.* hypothesized that additional answers to both of these questions are found in [bottom-up control](wiki:Population_ecology#Top-down_and_bottom-up_controls), modulated by the phenomena in oceans and lakes called [Mixed layers](./MixedLayers.md).
